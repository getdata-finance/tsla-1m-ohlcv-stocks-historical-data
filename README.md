...
- **Free evaluation sample** on GitHub (`1m`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/tsla) · **617,080** `1m` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `1m` sample updated in sync

> **Sample on GitHub** · `TSLA_1m.csv` (55,440 rows, `2026-02-06` -> `2026-09-01`). **Full archive on [getdata.finance](https://getdata.finance/datasets/tsla)** — **617,080** `1m` rows, **11 timeframes**, `2020-02-25` -> `2026-09-01`.

## Download sample

**[TSLA_1m.csv](https://github.com/getdata-finance/tsla-1m-ohlcv-stocks-historical-data/blob/main/TSLA_1m.csv)** on GitHub ([raw CSV](https://raw.githubusercontent.com/getdata-finance/tsla-1m-ohlcv-stocks-historical-data/main/TSLA_1m.csv))
...
This GitHub repository ships a **`1m` evaluation sample** only. On **[getdata.finance](https://getdata.finance/datasets/tsla)**, each full asset archive is delivered as a ZIP with **11 gap-free OHLCV timeframes**:
...
Full TSLA archive — 11 timeframes, gap-free, updated weekly:
