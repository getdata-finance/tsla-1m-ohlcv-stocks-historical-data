...
> **Sample on GitHub** · `TSLA_1m.csv` (55,440 rows, `2026-02-06` -> `2026-09-01`, 5.71 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/tsla)** — **617,080** `1m` rows (full `1m`: 617,080), **11 timeframes**, `2020-02-25` -> `2026-09-01`.
